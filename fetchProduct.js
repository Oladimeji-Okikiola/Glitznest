...
// Calling the product categories
let jeweleries = document.getElementById('jeweleries')
let KitchenUtensils = document.getElementById('KitchenUtensils')
let Laundary = document.getElementById('Laundary')
let Clothing = document.getElementById('Clothing')
let Bathroom = document.getElementById('Bathroom')
let homeDecoration = document.getElementById('homeDecoration')
let phoneAccessories = document.getElementById('phoneAccessories')
